...
let Country = (() => {
    ...
    let _phoneCodes_decorators;
    let _phoneCodes_initializers = [];
    let _currencies_decorators;
    let _currencies_initializers = [];
    var Country = _classThis = class {
        constructor() {
            ...
            // relations
            this.phoneCodes = __runInitializers(this, _phoneCodes_initializers, void 0);
            this.currencies = __runInitializers(this, _currencies_initializers, void 0);
        }
    };
    ...
    (() => {
        ...
        _fullname_decorators = [(0, typeorm_1.Column)({ type: 'varchar' })];
        ...
        _phoneCodes_decorators = [(0, typeorm_1.OneToMany)(() => phoneCode_entity_1.PhoneCode, (phoneCode) => phoneCode.country, {
                onDelete: 'CASCADE',
            })];
        _currencies_decorators = [(0, typeorm_1.OneToMany)(() => currency_entity_1.Currency, (currency) => currency.country, {
                onDelete: 'CASCADE',
            })];
        ...
        __esDecorate(null, null, _phoneCodes_decorators, { kind: "field", name: "phoneCodes", static: false, private: false, access: { has: obj => "phoneCodes" in obj, get: obj => obj.phoneCodes, set: (obj, value) => { obj.phoneCodes = value; } }, metadata: _metadata }, _phoneCodes_initializers, _instanceExtraInitializers);
        __esDecorate(null, null, _currencies_decorators, { kind: "field", name: "currencies", static: false, private: false, access: { has: obj => "currencies" in obj, get: obj => obj.currencies, set: (obj, value) => { obj.currencies = value; } }, metadata: _metadata }, _currencies_initializers, _instanceExtraInitializers);
