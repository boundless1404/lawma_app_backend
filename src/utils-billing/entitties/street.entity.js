...
const lgaWard_entity_1 = require("./lgaWard.entity");
...
let Street = (() => {
    ...
    let _lgaWard_decorators;
    let _lgaWard_initializers = [];
    ...
    var Street = _classThis = class {
        constructor() {
            ...
            // lga: Lga;
            this.lgaWard = __runInitializers(this, _lgaWard_initializers, void 0);
    ...
    __setFunctionName(_classThis, "Street");
    (() => {
        ...
        _lgaWardId_decorators = [(0, typeorm_1.Column)({ type: 'bigint' })];
        _entityProfileId_decorators = [(0, typeorm_1.Column)({ type: 'bigint' })];
        _lgaWard_decorators = [(0, typeorm_1.ManyToOne)(() => lgaWard_entity_1.LgaWard, (lgaWard) => lgaWard.streets)];
        _propertySubscriptions_decorators = [(0, typeorm_1.OneToMany)(() => propertySubscription_entity_1.PropertySubscription, (property) => property.street)];
        _entityProfile_decorators = [(0, typeorm_1.ManyToOne)(() => entityProfile_entity_1.EntityProfile, (entityProfile) => entityProfile.streets), (0, typeorm_1.JoinColumn)({ name: 'entityProfileId' })];
        ...
        __esDecorate(null, null, _lgaWard_decorators, { kind: "field", name: "lgaWard", static: false, private: false, access: { has: obj => "lgaWard" in obj, get: obj => obj.lgaWard, set: (obj, value) => { obj.lgaWard = value; } }, metadata: _metadata }, _lgaWard_initializers, _instanceExtraInitializers);
        ...
        Street = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return Street = _classThis;
})();
