...
export class FixRoleUniqueConstraint1761478443623
  implements MigrationInterface
{
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "role" ADD CONSTRAINT "UQ_role_name_entity" UNIQUE ("name", "entityProfileId")`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "role" DROP CONSTRAINT IF EXISTS "UQ_role_name_entity"`,
    );
