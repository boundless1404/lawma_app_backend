...
let AuthController = (() => {
    ...
    let _signupCompanyUser_decorators;
    let _login_decorators;
    var AuthController = _classThis = class {
        constructor(authService, profileService, sharedService) {
    ...
    (() => {
        ...
        _signupCompanyUser_decorators = [(0, common_1.Post)('signup')];
        ...
        __esDecorate(_classThis, null, _signupCompanyUser_decorators, { kind: "method", name: "signupCompanyUser", static: false, private: false, access: { has: obj => "signupCompanyUser" in obj, get: obj => obj.signupCompanyUser }, metadata: _metadata }, null, _instanceExtraInitializers);
