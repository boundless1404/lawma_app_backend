...
let HelpersService = (() => {
    ...
    let _classThis;
    var HelpersService = _classThis = class {
        constructor(dbSource) {
            this.dbSource = dbSource;
            //
            this.dbManager = this.dbSource.manager;
        }
        getEntityUserProfileByEmailOrId({ email, entityUserProfileId, }) {
            return __awaiter(this, void 0, void 0, function* () {
                const entityUserProfile = yield this.dbManager.findOne(entityUserProfile_entity_1.EntityUserProfile, {
                    where: Object.assign({}, (email ? { email } : { id: entityUserProfileId })),
                });
